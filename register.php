...
if( isset($_POST['submit']) ){
        ...
        if(!empty(trim($name)) && !empty(trim($username)) && !empty(trim($email)) && !empty(trim($password)) && !empty(trim($repass))){
            ...
            if($password == $repass){
                ...
                if( cek_nama($name,$con) == 0 ){
                    ...
                    $query = "INSERT INTO register (username,name,email, password ) VALUES ('$username','$name','$email','$pass')";
    ...
    function cek_nama($username,$con){
        ...
        $query = "SELECT * FROM regis WHERE username = '$nama'";
            ...
            <section class="col-12 col-sm-6 col-md-4">
                <form class="form-container" action="register.php" method="POST">
                    ...
                    <div class="form-footer mt-2">
                        <p> <center> Sudah punya account? <a href="login.php">Login</a> </center> </p>
                    </div>
                </form>
            </section>
            </section>
